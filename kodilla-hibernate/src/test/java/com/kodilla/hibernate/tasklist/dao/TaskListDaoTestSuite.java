...
public class TaskListDaoTestSuite {
    ...
    public void testFindByListName() {
        //Given
        TaskList taskList = new TaskList("Tasks in progress", "Zadanie 13.2");
    ...
    public void testTaskListDaoSaveWithTasks() {
        ...
        TaskList taskList = new TaskList("Training tasks", "ToDo tasks");
    ...
    public void testNamedQueries() {
        ...
        TaskList taskList = new TaskList("Lista testowa", "ToDo tasks");
