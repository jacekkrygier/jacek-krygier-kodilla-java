...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://jacekkrygier.github.io/";
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                                .getText().equals(taskName))
                .forEach(task -> {
                    WebElement deleteTask = task.findElement(By.xpath(".//button[4]"));
                    deleteTask.click();
                });
        Thread.sleep(5000);
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("jacekkrygier1705@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("misiek12345");
        ...
        result = driverTrello.findElements(By.xpath("//div[@id =\"board\"]")).stream()
